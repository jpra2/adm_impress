...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas = np.load('flying/6k/results_6k_SchmallNEW_32_IMPEC_100days_dt1728_5004.npy', allow_pickle=True)
        ...
        datas3 = np.load('flying/6k/results_6k_SchmallNEW_32_FI_100days_dt1728_5001.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        import pdb; pdb.set_trace()
        plt.figure(1)
        plt.title('t = 100 days - 32x1x1 mesh')
        ...
        plt.grid()
        plt.savefig('results/6k_32/100days/pressure_6k_100days' + '.png')

        plt.figure(2)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1, So_FOU, 'k')
        #plt.plot(x1, So_MUSCL, 'g')
        plt.plot(x1[0:-1], So_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/saturation_oil_6k_100days' + '.png')

        plt.figure(3)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1, Sw_FOU, 'k')
        #plt.plot(x1, Sw_MUSCL, 'g')
        plt.plot(x1[0:-1], Sw_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/saturation_water_6k_100days' + '.png')

        plt.figure(4)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1[0:-1], Sg_FOU[0:-1], 'k')
        #plt.plot(x1, Sg_MUSCL, 'g')
        plt.plot(x1[0:-1], Sg_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/saturation_gas_6k_100days' + '.png')

        plt.figure(5)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1, zC1_FOU, 'k')
        #plt.plot(x1, zC1_MUSCL, 'g')
        plt.plot(x1[0:-1], zC1_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/zC1_6k_FOU_100days' + '.png')

        plt.figure(6)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1, zC3_FOU, 'k')
        #plt.plot(x1, zC3_MUSCL, 'g')
        plt.plot(x1[0:-1], zC3_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/zC3_6k_FOU_100days' + '.png')

        plt.figure(7)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1, zC6_FOU, 'k')
        #plt.plot(x1, zC6_MUSCL, 'g')
        plt.plot(x1[0:-1], zC6_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/zC6_6k_FOU_100days' + '.png')

        plt.figure(8)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1, zC10_FOU, 'k')
        #plt.plot(x1, zC10_MUSCL, 'g')
        plt.plot(x1[0:-1], zC10_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/zC10_6k_FOU_100days' + '.png')

        plt.figure(9)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1, zC15_FOU, 'k')
        #plt.plot(x1, zC15_MUSCL, 'g')
        plt.plot(x1[0:-1], zC15_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/zC15_6k_FOU_100days' + '.png')

        plt.figure(10)
        plt.title('t = 100 days - 32x1x1 mesh')
        plt.plot(x1, zC20_FOU, 'k')
        #plt.plot(x1, zC20_MUSCL, 'g')
        plt.plot(x1[0:-1], zC20_FI[0:-1], '-bo')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/100days/zC20_6k_FOU_100days' + '.png')
