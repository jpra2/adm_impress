...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        plt.ylabel('Composição global do C1')
        plt.xlabel('Distância (m)')
        plt.grid()
        #plt.ylim((0.37, 0.45))
        plt.savefig('results/6k/6k_2000/zC1_6k_FOU_20days' + '.png')
        ...
        plt.ylabel('Composição global do C3')
        plt.xlabel('Distância (m)')
        plt.grid()
        #plt.ylim((0.0315, 0.034))
        plt.savefig('results/6k/6k_2000/zC3_6k_FOU_20days' + '.png')
        ...
        plt.legend(('CMG - 5000 CVs', 'FI 200 CVs'), loc=4)
        plt.ylabel('Composição global do C6')
        plt.xlabel('Distância (m)')
        plt.grid()
        #plt.ylim((0.077, 0.088))
        plt.savefig('results/6k/6k_2000/zC6_6k_FOU_20days' + '.png')
        ...
        plt.legend(('CMG - 5000 CVs', 'FI 200 CVs'), loc=4)
        plt.ylabel('Composição global do C10')
        plt.xlabel('Distância (m)')
        plt.grid()
        #plt.ylim((0.22, 0.26))
        plt.savefig('results/6k/6k_2000/zC10_6k_FOU_20days' + '.png')
        ...
        plt.legend(('CMG - 5000 CVs', 'FI 200 CVs'), loc=4)
        plt.ylabel('Composição global do C15')
        plt.xlabel('Distância (m)')
        plt.grid()
        #plt.ylim((0.165, 0.195))
        plt.savefig('results/6k/6k_2000/zC15_6k_FOU_20days' + '.png')
        ...
        plt.legend(('CMG - 5000 CVs', 'FI 200 CVs'), loc=4)
        plt.ylabel('Composição global do C20')
        plt.xlabel('Distância (m)')
        plt.grid()
        #plt.ylim((0.054, 0.065))
        plt.savefig('results/6k/6k_2000/zC20_6k_FOU_20days' + '.png')
