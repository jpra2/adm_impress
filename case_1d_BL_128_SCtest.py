...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas = np.load('flying/Teste_criterio_de_parada/BL/128_CV/results_Buckley_Leverett_case_128_FI_ADIMENSIONALIZADO_e9dt20_63.npy', allow_pickle=True)
        ...
        datas = np.load('flying/Teste_criterio_de_parada/BL/128_CV/results_Buckley_Leverett_case_128_FI_ADIMENSIONALIZADO_e6dt20_63.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas[1:]:
            Sw_FI_e6 = data[5]
            So_FI_e6 = data[6]
        ...
        datas = np.load('flying/Teste_criterio_de_parada/BL/128_CV/results_Buckley_Leverett_case_128_FI_ADIMENSIONALIZADO_e3dt1_NEW_693.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas[1:]:
            Sw_FI_e3 = data[5]
            So_FI_e3 = data[6]
        ...
        datas = np.load('flying/Teste_criterio_de_parada/BL/128_CV/results_Buckley_Leverett_case_128_FI_ADIMENSIONALIZADO_e2dt20_64.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas[1:]:
            Sw_FI_e2 = data[5]
            So_FI_e2 = data[6]
        ...
        plt.grid()
        plt.savefig('results/Teste_criterio_de_parada/BL/128_CV/BL_Sw_128_' + '{}'.format(n) + '.png')
