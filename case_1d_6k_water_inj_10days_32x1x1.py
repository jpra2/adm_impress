...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas = np.load('flying/results_6k_SchmallNEW_32_IMPEC_10days_MERGER_502.npy', allow_pickle=True)
        ...
        datas3 = np.load('flying/results_6k_SchmallNEW_32_FI_10days_MERGER_501.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        """datas = np.load('flying/results_6k_SchmallNEW_8_IMPEC_10days_dt1728_501.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas[1:]:
            Sw_FOU = data[5]
            So_FOU = data[6]
        ...
        datas = np.load('flying/results_6k_SchmallNEW_8_FI_10days_dt1728_501.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas[1:]:
            Sw_FI = data[5]
            So_FI = data[6]
        ...
        #plt.legend(('IMPEC FOU', 'IMPEC MUSCL', 'FI'))
        #plt.legend(('IMPEC', 'MUSCL', 'FI dt 864', 'FI dt 1728'))
        plt.grid()
        plt.savefig('results/6k_32/pressure_6k_10days_MERGE' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/saturation_oil_6k_10days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/saturation_water_6k_10days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_32/saturation_gas_6k_10days' + '.png')

        """plt.figure(5)
        plt.title('t = 10 days - 8x1x1 mesh')
