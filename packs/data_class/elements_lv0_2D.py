...
class ElementsLv0(DataManager):
    ...
    def load_elements_from_mesh(self):
        ...
        self._data['internal_faces'] = self.mesh.edges.all[~self.mesh.bool_boundary_edges] #self.mesh.edges.internal
        self._data['boundary_faces'] = np.setdiff1d(self['faces'], self._data['internal_faces'])
        self._data['neig_faces'] = self.mesh.adjacencies #Verify this, i think its equivalent to the volumes adjacencies
        ...
        self._data['neig_boundary_faces'] = self._data['neig_boundary_faces'][self._data['neig_boundary_faces']>-1]
