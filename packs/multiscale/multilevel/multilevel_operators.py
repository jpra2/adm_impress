...
class MultilevelOperators(DataManager):
    ...
    def run_serial(self, T_fine_without_bc, global_source_term, dual_subdomains, global_vector_update, global_diagonal_term, OP_AMS, level, master_local_operator, **kwargs):
        ...
        master = master_local_operator
        OP_AMS, correction_function = master.run_serial(OP_AMS, dual_subdomains)
