...
def setup4_lpew2():
    ...
    """
    mesh_test_name = defpaths.oblique_quad_mesh
    mesh_properties_name = defpaths.mesh_prop_test7 + '_lpew2'
    mesh_verify(mesh_test_name)
    mesh_properties: MeshProperty = create_properties_if_not_exists(mesh_test_name, mesh_properties_name)
    ...
    diamond = DiamondFluxCalculation()
    
    resp = diamond.mount_problem(bc, **mesh_properties.get_all_data())
    ...
    mesh_data.create_tag('pressure_error')
    mesh_data.insert_tag_data('pressure_error', error, 'faces', mesh_properties.faces)
    mesh_data.export_all_elements_type_to_vtk('test_7_nodes_lpew2', 'nodes')
    mesh_data.export_all_elements_type_to_vtk('test_7_faces_lpew2', 'faces')
    mesh_data.export_only_the_elements('test_7_nodes_pressure_boundary_lpew2', 'nodes', nodes_bc)
    # import pdb; pdb.set_trace()
...
def setup5():
    ...
    def get_linear_exact_solution(centroids):
        x = centroids[:, 0]
        return x
...
def setup6():
    ...
    mesh_test_name = defpaths.linear_2k_test
    mesh_properties_name = defpaths.mesh_prop_linear_2k + '_lpew2'
    mesh_verify(mesh_test_name)
    mesh_properties: MeshProperty = create_properties_if_not_exists(mesh_test_name, mesh_properties_name)
