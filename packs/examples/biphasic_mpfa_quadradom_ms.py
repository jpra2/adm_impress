...
from packs.examples.biphasic_mpfa_quadradom_finescale import (
...
def get_properties_coarse():
    coarse_mesh_properties_name = 'coarse1_quadradom'
    coarse_mesh_path = defpaths.quadrado_mesh_coarse
...
def run6():
    ...
    lsds = LsdsFluxCalculation()
    simulation_data = SimulationData('biphasic_nuadm_quadradom_ms')
