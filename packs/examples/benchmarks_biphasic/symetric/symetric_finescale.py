...
def get_properties():
    fine_mesh_properties_name = 'finescale_symetric'
    fine_mesh_path = defpaths.symetric_finescale
...
def set_permeability(fine_mesh_path, fine_properties: MeshProperty, export_permfield=True, update_permfield=True, **kwargs):
    ...
    faces1 = fine_properties['physical_quad_1']
    faces2 = fine_properties['physical_quad_2']
    faces3 = fine_properties['physical_quad_3']
    faces4 = fine_properties['physical_quad_4']
    faces5 = fine_properties['physical_quad_5']
    faces6 = fine_properties['physical_quad_6']
    faces7 = fine_properties['physical_quad_7']
