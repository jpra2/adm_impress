...
def get_properties():
    ...
    fine_mesh_properties_name = 'ftest3'
    fine_mesh_path = defpaths.ftest3

    fine_properties = preprocess_mesh(fine_mesh_path, fine_mesh_properties_name, defpaths.ftest3_v4)
...
def run5():
    ...
    gdict = {
        'funcname': '',
        'file_times': 'functions_times_ftest3.yaml',
    ...
    simulation_data = SimulationData('ftest3')
    simulation_data.insert_or_update_data({'label': np.array(['ftest3'])})
