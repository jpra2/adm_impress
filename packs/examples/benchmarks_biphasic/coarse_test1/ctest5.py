...
def get_properties_coarse():
    coarse_mesh_properties_name = 'ctest1_5'
    coarse_mesh_path = defpaths.ctest1_5
...
def run6():
    ...
    gdict = {
        'funcname': '',
        'file_times': 'functions_times_ctest1_5.yaml',
    ...
    simulation_data = SimulationData('biphasic_ctest1_5')
    simulation_data.insert_or_update_data({'label': np.array(['ctest1_5'])})
