...
def get_properties_coarse():
    coarse_mesh_properties_name = 'ctest1_4'
    coarse_mesh_path = defpaths.ctest1_4
...
def run6():
    ...
    gdict = {
        'funcname': '',
        'file_times': 'functions_times_ctest1_4.yaml',
    ...
    simulation_data = SimulationData('biphasic_ctest1_4')
    simulation_data.insert_or_update_data({'label': np.array(['ctest1_4'])})
