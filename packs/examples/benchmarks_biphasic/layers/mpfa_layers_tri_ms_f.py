...
from packs.examples.benchmarks_biphasic.layers.mpfa_layers_tri_finescale_ff import (
...
def get_properties_coarse():
    coarse_mesh_properties_name = 'coarse1_layers_tri_f'
    coarse_mesh_path = defpaths.layers_tri_coarse_f
