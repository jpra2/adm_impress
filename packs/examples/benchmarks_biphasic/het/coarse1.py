...
from packs.examples.benchmarks_biphasic.het.fine1 import (
...
def get_properties_coarse():
    coarse_mesh_properties_name = 'coarse1_het'
    coarse_mesh_path = defpaths.het_coarse1_mesh
...
def run6():
    ...
    simulation_data = SimulationData('biphasic_het_coarse1')
