function [sol, nbroy, ciclos] = brsola(M_old,RHS_old,p_old,tol,kmap,parameter,...
    metodoP,auxflag,w,s,nflagface,fonte,gamma,nflagno,benchmark,p_old1,...
    weightDMP,auxface,calnormface,wells,mobility)
...
rtol=1e-8; atol=1e-7; n = length(p_old); fnrm=1; itc=0; nbroy=0;
%
