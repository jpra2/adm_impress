...
% exemplo: tensor de permeabilidade (kmap), press�o analitica (u), termos de fonte (fonte),
...
switch benchmark
    ...
    case 'edwards'
        ...
        c1=(1/50)*(1/10)*f;
        d1=d2;
        % calculo da solu��o exata, termo fonte e adequa o tensor de
        % permeabilidade
        for ielem=1:size(elem,1)
            x=centelem(ielem,1);
            y=centelem(ielem,2);
...
%         bcflag(2,2)=2;
    ...
    case 'pinchout'
        % n�o de definimos porque tudo esta definido no start
        elem=elem;
        K=kmap;
    case 'shuecv1'
