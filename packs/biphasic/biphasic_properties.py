...
class biphasicProperties(StructuredMeshProperties):
    ...
    def g_w_internal_faces():
        ...
        def fget(self):
            ...
            return -self.grad_z_internal_faces*self.lambda_w_internal_faces*gama_w
        return locals()
    ...
    def g_o_internal_faces():
        ...
        def fget(self):
            ...
            return -self.grad_z_internal_faces*self.lambda_o_internal_faces*gama_o
        return locals()
    ...
    def q_w_internal_faces():
        ...
        def fget(self):
            ...
            # f = self.fw_internal_faces*(self.flux_sigma_internal_faces + self.lambda_o_internal_faces*ak*(self.g_w_internal_faces - self.g_o_internal_faces))
            f = self.fw_internal_faces*(self.flux_sigma_internal_faces + self.lambda_o_internal_faces*ak*(gama_w - gama_o))
            return f
        return locals()
    ...
    def q_o_internal_faces():
        ...
        def fget(self):
            ...
            # f = (1 - self.fw_internal_faces)*(self.flux_sigma_internal_faces - self.lambda_w_internal_faces*ak*(self.g_w_internal_faces - self.g_o_internal_faces))
            f = (1 - self.fw_internal_faces)*(self.flux_sigma_internal_faces - self.lambda_w_internal_faces*ak*(gama_w - gama_o))
            return f
        return locals()
