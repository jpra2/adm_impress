...
class BiphasicTpfa(FineScaleTpfaPressureSolver, biphasicProperties):
    ...
    def update_flux_w_and_o_volumes(self):
        ...
        fw_internal_faces = lambda_w_internal_faces/(lambda_w_internal_faces + lambda_o_internal_faces)
        # fo_internal_faces = 1 - fw_internal_faces
        ...
        self.data_impress['flux_press_o_faces_vec'][internal_faces] = flux_o_internal_faces.reshape((ni, 1))*u_normal_internal_faces
