...
class StabilityCheck:
    ...
    #*****************************Test two**********************************#
        ...
        KWilson_criteria = np.sum(abs(K-1)<1e-14,axis=0,dtype=bool)
        K[:,KWilson_criteria] = self.self.equilibrium_ratio_Wilson(P_new[KWilson_criteria])
        self.K[:,ponteiro_stab_check] = K
