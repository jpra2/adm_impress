...
class GlobalIMPECPressureSolver:
    ...
    @staticmethod
    def mount_independent_term(Vbulk, porosity, Cf, dVtdP, P, n_volumes, n_components, n_phases, internal_faces_adjacencies, dVtdk, z_centroids, xkj_internal_faces, Csi_j_internal_faces, mobilities_internal_faces, pretransmissibility_internal_faces, Pcap):
    ...
    @staticmethod
    def gravity_independent_term(n_volumes, n_components, internal_faces_adjacencies, dVtdk, z_centroids):
        """
    ...
    @staticmethod
    def capillary_independent_term(xkj_internal_faces, Csi_j_internal_faces, mobilities_internal_faces, pretransmissibility_internal_faces, n_components, n_phases, n_volumes, dVtdk, Pcap):
        """
