...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas = np.load('flying/6k/results_6k_SchmallNEW_32_IMPEC_20days_dt1728_1004.npy', allow_pickle=True)
        ...
        datas3 = np.load('flying/6k/results_6k_SchmallNEW_32_FI_20days_dt1728_1001.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
