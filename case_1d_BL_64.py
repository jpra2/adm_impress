...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas2 = np.load('flying/BL_Teste2/results_Buckley_Leverett_case_64_FI_70.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        datas3 = np.load('flying/BL_Teste2/results_Buckley_Leverett_case_64_FI_TESTE_70.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
