...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas = np.load('flying/Teste_criterio_de_parada/16_CV/results_6k_SchmallNEW_16_FI_20days_ADIMENSIONALIZADO_POCONEW_91.npy', allow_pickle=True)
        ...
        for data in datas[1:]:
            ...
            zC3_FI_e4 = data[10][1]
            zC6_FI_e4 = data[10][2]
            zC10_FI_e4 = data[10][3]
            zC15_FI_e4 = data[10][4]
            zC20_FI_e4 = data[10][5]
            x1 = np.linspace(0, 50, n)

        datas2 = np.load('flying/Teste_criterio_de_parada/16_CV/results_6k_SchmallNEW_16_FI_20days_SC0_001_NEWDT_202.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        datas3 = np.load('flying/Teste_criterio_de_parada/16_CV/results_6k_SchmallNEW_16_FI_20days_SC0_01_NEWDT_202.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        datas4 = np.load('flying/Teste_criterio_de_parada/16_CV/results_6k_SchmallNEW_16_FI_20days_SC0_1_NEWDT_202.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        datas5 = np.load('flying/Teste_criterio_de_parada/16_CV/results_6k_SchmallNEW_16_FI_20days_ADIMENSIONALIZADO_e6_202.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        plt.figure(1)
        plt.title('t = 20 days - 16x1x1 mesh')
        plt.plot(x1, pressure_FI_e4, 'y')
        ...
        plt.xlabel('Distance')
        plt.legend(('1e-4', '1e-3', '1e-2', '1e-1', '1e0'))
        plt.grid()
        plt.savefig('results/Teste_criterio_de_parada/6k/16_CV/pressure_20days' + '.png')

        plt.figure(2)
        plt.title('t = 20 days - 16x1x1 mesh')
        plt.plot(x1, So_FI_e4, 'y')
        ...
        plt.xlabel('Distance')
        plt.legend(('1e-4', '1e-3', '1e-2', '1e-1', '1e0', 'CMG'))
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/Teste_criterio_de_parada/6k/16_CV/saturation_oil_6k_20days' + '.png')

        plt.figure(3)
        plt.title('t = 20 days - 16x1x1 mesh')
        plt.plot(x1, Sw_FI_e4, 'y')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/Teste_criterio_de_parada/6k/16_CV/saturation_water_6k_20days' + '.png')

        plt.figure(4)
        plt.title('t = 20 days - 16x1x1 mesh')
        plt.plot(x1, Sg_FI_e4, 'y')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/Teste_criterio_de_parada/6k/16_CV/saturation_gas_6k_20days' + '.png')
