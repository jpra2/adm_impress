...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas3 = np.load('flying/6k/100_0_0/results_6k_SchmallNEW_100_FI_20days_POCONEW_204.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        #plt.plot(x1_100, So_FI, 'r')
        plt.plot(x1_100, So_FI_2, '--r')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k/6k_100/20days/saturation_oil_6k_20days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k/6k_100/20days/saturation_water_6k_20days' + '.png')
        ...
        #plt.plot(x1_100, Sg_FI, 'r')
        plt.plot(x1_100, Sg_FI_2, '--g')
        plt.legend(('CMG - 5000 elements', 'FI'))
        #plt.legend(('IMPEC', 'FI', 'FI Teste'))
        #plt.legend(('IMPEC', 'MUSCL', 'FI dt 864', 'FI dt 1728'))
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k/6k_100/20days/saturation_gas_6k_20days' + '.png')
