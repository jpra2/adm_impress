...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas2 = np.load('flying/Teste_criterio_de_parada/8_CV/results_6k_SchmallNEW_8_FI_20days_SC0_001_22.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        datas3 = np.load('flying/Teste_criterio_de_parada/8_CV/results_6k_SchmallNEW_8_FI_20days_SC0_01_22.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        datas4 = np.load('flying/Teste_criterio_de_parada/8_CV/results_6k_SchmallNEW_8_FI_20days_SC0_1_22.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        plt.grid()
        plt.savefig('results/Teste_criterio_de_parada/6k/8_CV/pressure_20days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/Teste_criterio_de_parada/6k/8_CV/saturation_oil_6k_20days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/Teste_criterio_de_parada/6k/8_CV/saturation_water_6k_20days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/Teste_criterio_de_parada/6k/8_CV/saturation_gas_6k_20days' + '.png')
