...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas4 = np.load('flying/6k/results_6k_SchmallNEW_32_FI_10days_dt1728_test_501.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas4[1:]:
            Sw_FI2 = data[5]
            So_FI2 = data[6]
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/saturation_water_6k_10days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/saturation_gas_6k_10days' + '.png')
