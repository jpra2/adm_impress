...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas2 = np.load('flying/BL_Teste2/results_Buckley_Leverett_case_8_FI_36.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        datas3 = np.load('flying/results_Buckley_Leverett_case_8_FI_Novo_36.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        plt.grid()
        plt.savefig('results/BL_Sw_8_' + '{}'.format(n) + '.png')
