...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas = np.load('flying/Teste_criterio_de_parada/BL/8_CV/results_Buckley_Leverett_case_8_FI_ADIMENSIONALIZADO_e9_36.npy', allow_pickle=True)
        ...
        datas = np.load('flying/Teste_criterio_de_parada/BL/8_CV/results_Buckley_Leverett_case_8_FI_ADIMENSIONALIZADO_e6_36.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas[1:]:
            Sw_FI_e6 = data[5]
            So_FI_e6 = data[6]
        ...
        datas = np.load('flying/Teste_criterio_de_parada/BL/8_CV/results_Buckley_Leverett_case_8_FI_ADIMENSIONALIZADO_e3_NEW_36.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas[1:]:
            Sw_FI_e3 = data[5]
            So_FI_e3 = data[6]
        ...
        datas = np.load('flying/Teste_criterio_de_parada/BL/8_CV/results_Buckley_Leverett_case_8_FI_ADIMENSIONALIZADO_e2_36.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        for data in datas[1:]:
            Sw_FI_e2 = data[5]
            So_FI_e2 = data[6]
        ...
        plt.grid()
        plt.savefig('results/Teste_criterio_de_parada/BL/8_CV/BL_Sw_8_' + '{}'.format(n) + '.png')
