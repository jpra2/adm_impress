    ...
    if  arq.startswith(name):
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x8[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
            x8 = x8.flatten()
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x16[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
            x16 = x16.flatten()
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x32[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
            x32 = x32.flatten()
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x64[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
            x64 = x64.flatten()
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x128[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
            x128 = x128.flatten()
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x256[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
            x256 = x256.flatten()
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x512[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
            x512 = x512.flatten()
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x8_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x16_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x32_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x64_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x128_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x256_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x512_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x8_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x16_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x32_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x64_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x128_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x256_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x512_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*L/(2*n),L-(1-points[i])*L/(2*n),n)
        ...
        plt.ylabel('log$_{10}(E_{L_1})$')
        plt.xlabel('$log_{10}(N)$')
        plt.savefig('results/compositional/FR_paper/saturation_BL_Bastian_FR_converg.eps', format='eps')
