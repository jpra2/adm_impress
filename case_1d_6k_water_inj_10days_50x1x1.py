...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        #datas = np.load('flying/6k/results_6k_SchmallNEW_50_IMPEC_FOU_10days_505.npy', allow_pickle=True)
        datas = np.load('flying/6k/results_6k_SchmallNEW_50_IMPEC_FOU_10days_DTMAIOR_202.npy', allow_pickle=True)
        ...
        datas2 = np.load('flying/6k/results_6k_SchmallNEW_50_MUSCL_10days_634.npy', allow_pickle=True)
        #import pdb; pdb.set_trace()
        ...
        plt.grid()
        plt.savefig('results/6k_50/10days/pressure_6k_10days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_50/10days/saturation_oil_6k_10days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_50/10days/saturation_water_6k_10days' + '.png')
        ...
        plt.grid()
        #plt.ylim((0,1))
        plt.savefig('results/6k_50/10days/saturation_gas_6k_10days' + '.png')
